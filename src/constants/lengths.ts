...
export const PLAYER_POSITION_MAX_LENGTH = 10;
export const PLAYER_NATIONALITY_MAX_LENGTH = 127;
export const PLAYER_SUGGESTION_MAX_LENGTH = 127;
...
export const MESSAGE_MAX_LENGTH = 1023;
