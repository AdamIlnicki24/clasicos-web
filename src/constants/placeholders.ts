...
export const PLAYER_NAME_PLACEHOLDER = "Wpisz imię piłkarza";
export const PLAYER_NATIONALITY_PLACEHOLDER = "Wpisz narodowość piłkarza";
export const COMMENT_CONTENT_PLACEHOLDER = "Historia El Clasico pasjonowała mnie od zawsze.";
